<%-- 
    ...
    Created on : 9 Νοε 2015, 1:45:12 μμ
    Author     : nsak
--%>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div>
                            <form method='post' action='CMSP_results.jsp' role="form">
                            <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped" border="1" width="30%" cellpading="3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="pieces" value="" /></td>
                                        </tr>
                                        <tr>
                                ...
                                <input type="reset" value="Clear" name="reset" class="btn btn-primary" />
...
<html>
    ...
    <body>
        ...
        <h1>Calculate Minimum Sell Price</h1>
    </body>
</html>

<form method='post' action='CMSP_results.jsp'>
    
    <table border="1" width="30%" cellpading="3">
