    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.jsp">My Portfolio Management System</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="calculate_min_sell.jsp">Calculate Min</a>
                                </li>
                                <li>
...
con=(Connection)DriverManager.getConnection("jdbc:mysql://localhost:3306/sakila", "root", "lotrrotk1");
PreparedStatement ps=(PreparedStatement)con.prepareStatement("select * from actor");
